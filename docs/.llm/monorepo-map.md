...
| Introduction: Tour | `docs/introduction/tour.md` | Extensive revenge-story walkthrough of the Viv language, showing actions, roles, conditions, effects, reactions, plans, selectors, sifting patterns, knowledge propagation, and item inscription in a single extended example. Keywords: tour, example, walkthrough, revenge story, tutorial, end-to-end, runtime API |
