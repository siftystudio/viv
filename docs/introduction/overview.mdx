...
Ready for a deep dive? The [next page](/introduction/example/) is an extensive tour that walks through the authoring and simulation of a revenge arc in Viv—from a character scribbling a gossip note, to an arson, to a knowledge-propagating monument recounting it all for posterity.
