...
MANIFEST: Manifest = [
    ...
    Bundle(
        ...
        sources=[
            ...
            Source(path="docs/reference/language/05-entities-and-symbols.mdx", modality=_PROSE_MODALITY),
            ...
            Source(path="docs/reference/language/22-glossary.mdx", modality=_PROSE_MODALITY),
    ...
    Bundle(
        ...
        sources=[
            ...
            Source(path="docs/reference/language/20-runtime-model.mdx", modality=_PROSE_MODALITY),
